...
class Python3ParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Python3Parser#stmt_wildcard.
    def enterStmt_wildcard(self, ctx:Python3Parser.Stmt_wildcardContext):
        pass

    # Exit a parse tree produced by Python3Parser#stmt_wildcard.
    def exitStmt_wildcard(self, ctx:Python3Parser.Stmt_wildcardContext):
        pass
    ...
    # Enter a parse tree produced by Python3Parser#atom_wildcard.
    def enterAtom_wildcard(self, ctx:Python3Parser.Atom_wildcardContext):
        pass

    # Exit a parse tree produced by Python3Parser#atom_wildcard.
    def exitAtom_wildcard(self, ctx:Python3Parser.Atom_wildcardContext):
        pass
    ...
    # Exit a parse tree produced by Python3Parser#list_wildcard.
    def exitList_wildcard(self, ctx:Python3Parser.List_wildcardContext):
        pass
