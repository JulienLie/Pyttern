...
public interface Python3ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#wildcard_number}.
	 * @param ctx the parse tree
	 */
	void enterWildcard_number(Python3Parser.Wildcard_numberContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#wildcard_number}.
	 * @param ctx the parse tree
	 */
	void exitWildcard_number(Python3Parser.Wildcard_numberContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#stmt_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterStmt_wildcard(Python3Parser.Stmt_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#stmt_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitStmt_wildcard(Python3Parser.Stmt_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#expr_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterExpr_wildcard(Python3Parser.Expr_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#expr_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitExpr_wildcard(Python3Parser.Expr_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#atom_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterAtom_wildcard(Python3Parser.Atom_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#atom_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitAtom_wildcard(Python3Parser.Atom_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#simple_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterSimple_wildcard(Python3Parser.Simple_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#simple_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitSimple_wildcard(Python3Parser.Simple_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#number_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterNumber_wildcard(Python3Parser.Number_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#number_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitNumber_wildcard(Python3Parser.Number_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#double_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterDouble_wildcard(Python3Parser.Double_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#double_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitDouble_wildcard(Python3Parser.Double_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#var_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterVar_wildcard(Python3Parser.Var_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#var_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitVar_wildcard(Python3Parser.Var_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#contains_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterContains_wildcard(Python3Parser.Contains_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#contains_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitContains_wildcard(Python3Parser.Contains_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#compound_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterCompound_wildcard(Python3Parser.Compound_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#compound_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitCompound_wildcard(Python3Parser.Compound_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#simple_compound_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterSimple_compound_wildcard(Python3Parser.Simple_compound_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#simple_compound_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitSimple_compound_wildcard(Python3Parser.Simple_compound_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#multiple_compound_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterMultiple_compound_wildcard(Python3Parser.Multiple_compound_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#multiple_compound_wildcard}.
	 * @param ctx the parse tree
	 */
	void exitMultiple_compound_wildcard(Python3Parser.Multiple_compound_wildcardContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#list_wildcard}.
	 * @param ctx the parse tree
	 */
	void enterList_wildcard(Python3Parser.List_wildcardContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#list_wildcard}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterTransformation(Python3Parser.TransformationContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#transformation}.
	 * @param ctx the parse tree
	 */
	void exitTransformation(Python3Parser.TransformationContext ctx);
}